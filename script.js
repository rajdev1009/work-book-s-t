// script.js - Final Fixed & Improved Version
const bookData = {
    en: [
...
function speakCurrentPage() {
    ...
    const text = bookData.en[index].content;
...
function toggleTheme(theme) {
    ...
    // Add active to current theme button
    const activeBtn = document.querySelector(`.theme-switcher button[onclick="toggleTheme('${theme}')"]`);
...
function switchLanguage(lang) {
    ...
    // Future mein language support add kar sakte hain
}
